      ...
      >
        ...
        >
          <div
            style={{
              width: "5px",
              height: "500%", // Same height as the red line
              backgroundColor: pathname.includes("/home")
                ? "transparent"
                : "red",
            }}
          />
          ...
          {!pathname.includes("/home") &&
            !pathname.includes("/login") && ( // Hide the title if on /home or /login
              <Typography.Title
                level={1}
                style={{ margin: 0, fontSize: "60px" }}
              >
                EPD Defect Control
              </Typography.Title>
            )}
        ...
        >
          {/* <div onClick={changeTheme} className={styles.mode}>
            {toggleMode === "light" ? (
              ...
              <BsMoonStars color="#ffffff" size={20} />
            )}
          </div> */}
          {/* <LocaleSwitcher /> */}
          <UserMenu />
